...
```c
--8<-- "src/libuv/tcp-client/main.c"
```

### 示例代码：UDP 服务器

```c
--8<-- "src/libuv/udp-server/main.c"
```

### 示例代码：UDP 客户端

```c
--8<-- "src/libuv/udp-client/main.c"
```
...
```c
--8<-- "src/libuv/tcp-echo-server/main.c"
```

### 示例代码：TCP 客户端

```c
--8<-- "src/libuv/tcp-echo-client/main.c"
```
